/*
  # Restore Original User Trigger

  1. Changes
    - Restore handle_new_user() trigger to original version
    - Insert into both users and profiles tables
    - Restore full_name field handling
    - Restore tier field in profiles

  2. Important Notes
    - This restores the trigger to exactly how it was before the "fix"
    - Inserts into public.users table (lines 54-66)
    - Inserts into public.profiles table (lines 69-83)
*/
