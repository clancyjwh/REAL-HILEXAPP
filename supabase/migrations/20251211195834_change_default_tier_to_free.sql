/*
  # Change Default Tier to Free for New Signups

  ## Changes
  - Update sync_user_profile() trigger to set tier to 'free' instead of 'premium'
  - Update users.subscription_status to 'free' instead of 'premium'
*/
