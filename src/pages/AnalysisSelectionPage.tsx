...
export default function AnalysisSelectionPage() {
  ...
  const handleContinue = () => {
    if (selectedIndicators.size > 0) {
      ...
      navigate(`/tools/analysis/search?indicators=${indicatorsList}`);
    }
  };
          ...
          {indicators.map((indicator) => {
            ...
            const colorClasses = {
              ...
              purple: {
                ...
                hoverBg: 'hover:bg-gradient-to-br hover:from-purple-950/30 hover:to-slate-900',
                iconBg: isSelected ? 'bg-purple-500/20' : 'bg-purple-500/10',
