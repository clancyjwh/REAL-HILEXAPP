import { Clock, Settings, TrendingUp, BarChart3, Calendar, ArrowLeft, Zap, Award } from 'lucide-react';
...
const cards: InfoCard[] = [
  {
    title: 'About the Horizon Optimizer',
    icon: Zap,
    ...
    content: (
      <div className="space-y-4">
        <p className="text-slate-300 text-base leading-relaxed">
          The Horizon Optimizer is a powerful analytical tool that enables you to discover optimal indicator parameter settings tailored to specific assets. Rather than relying exclusively on pre-calculated configurations, you gain direct control over the optimization process, testing various parameter combinations against historical data to identify settings that demonstrated the strongest and most consistent patterns.
        </p>
        <p className="text-slate-300 text-base leading-relaxed">
          This tool empowers you to conduct independent historical analysis, customize evaluation periods, and uncover parameter configurations that align with your analytical methodology and specific market interests.
        </p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <p className="text-slate-300 text-base leading-relaxed">
          For every setting, we rewind the chart to many different points, note the indicator's value on that day, and then observe how prices moved over the next 10 days. This reveals which settings formed steady, repeatable patterns across different historical market conditions.
        </p>
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-slate-900/50 rounded-lg p-3">
            <p className="text-slate-300 text-sm">
              <span className="text-white font-semibold">MACD</span> tests the widest range, naturally producing the highest number of historical evaluations
            </p>
          </div>
        </div>
  ...
  {
    title: 'When a Historical Trade is Counted',
    icon: TrendingUp,
...
export default function HorizonOptimizerInfoPage() {
    ...
    <div className="min-h-screen pb-12">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-slate-400 mt-2 text-lg">
            Discover optimal indicator parameters tailored to specific assets through historical analysis
          </p>
        </div>
      </div>
      ...
      <div className="mt-12 bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
        <p className="text-slate-300 text-sm leading-relaxed text-center">
          The Horizon Optimizer enables independent parameter optimization analysis for any asset in our database.
