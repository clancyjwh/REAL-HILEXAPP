...
import { ArrowLeft, Activity, Bitcoin, TrendingUp, DollarSign, Boxes } from 'lucide-react';
...
export default function HorizonAssetClassPage() {
  const navigate = useNavigate();

  const handleAssetClassClick = (assetClassId: string) => {
    navigate(`/tools/horizon/${assetClassId}`);
  };
